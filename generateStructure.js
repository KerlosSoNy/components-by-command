...
// Default content for a React component
...
// Default content for a Redux slice
...
// Folder structure with placeholders for dynamic content
const folderStructure = [
  ...
  {
    name: 'redux',
    files: [],  // Redux files will be handled separately
    subfolders: []
  },
  {
    name: 'styles',
